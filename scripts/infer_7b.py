...
from mtvcrafter.models import MTVCrafterPipeline7B
from mtvcrafter.models import VectorQuantizer, Encoder, Decoder, SMPL_VQVAE
...
def main():
    ...
    parser.add_argument(
        ...
        required=False,
        help="path to the motion sequence",
    )
    parser.add_argument(
        "--output-path",
        "--output_dir",
